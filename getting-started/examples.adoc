...
A number of samples, or example applications are shipped with {PRODUCT} in the file, `bamoe-9.1.0-examples.zip`. 
...
|kogito-travel-agency|During this workshop you must create a software system for a startup travel agency called Kogito Travel Agency. It will be build incrementally where each version will be a separate folder.
