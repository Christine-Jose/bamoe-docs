...
More information on the capabilities and components of {PRODUCT_LONG} can be found in the https://www.ibm.com/docs/en/ibamoe/9.1.x?topic=overview-key-components[overview of components].
...
* For more information about setting up the ILMT License Service with {PRODUCT_LONG} see xref:ilmt-track-bamlcns-metrictool.adoc[Tracking BAMOE License use in IBM License Metric Tool]
