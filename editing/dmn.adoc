...
These new feature allows an interesting use case, that is filtering a base type based on its value, and then filtering a collection of the above element based on size (or other attribute) of the  collection itself.
