...
Once you select one of the two, you will navigate automatically to a new project, containing just the one file you just created.
...
Let's do that by creating another file using the “New file menu”. You will see that there are new controls available on the screen.
...
. *Repository status indicator* → Tells you the status of your repository.
  ...
  Note that it does not mean that you have the latest changes made to the remote Git repository.
