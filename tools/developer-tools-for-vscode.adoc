...
+
Since {PRODUCT_SHORT} {VERSION_910} a new DMN Editor is available. That is implemented with a modern technologies stack and with native support of DMN 1.5 specifications. This new editor can open 1.2, 1.3, 1.4, and 1.5 DMN file versions, and it automatically saves them to DMN 1.5. If you are upgrading from a previous {PRODUCT_SHORT} version (for example, {VERSION_900} or {VERSION_80}), your DMN files will be automatically converted to DMN 1.5 version without any loss of logic.
