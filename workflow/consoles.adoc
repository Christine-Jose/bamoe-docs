...
----
$ docker run -p 8280:8080 quay.io/bamoe/management-console:{IMAGE_VERSION_910}
----
+
[NOTE]
====
...
[source,subs="attributes"]
----
$ docker run -e RUNTIME_TOOLS_MANAGEMENT_CONSOLE_DATA_INDEX_ENDPOINT=http:/_HOST_:_PORT_/graphql -p 8280:8080 quay.io/bamoe/management-console:{IMAGE_VERSION_910}
----
====
...
Once a you are authenticated, Management Console uses bearer tokens to communicate with other {PRODUCT_SHORT} services.
...
$ docker run -e RUNTIME_TOOLS_MANAGEMENT_CONSOLE_KOGITO_ENV_MODE=PROD
  ...
  -p 8280:8080 quay.io/bamoe/management-console:{IMAGE_VERSION_910}
----
...
[source,subs="attributes"]
----
$ docker run -p 8280:8080 quay.io/bamoe/task-console:{IMAGE_VERSION_910}
----
...
[source,subs="attributes"]
----
$ docker run -e RUNTIME_TOOLS_TASK_CONSOLE_DATA_INDEX_ENDPOINT=http:/_HOST_:_PORT_/graphql -p 8280:8080 quay.io/bamoe/task-console:{IMAGE_VERSION_910}
----
====
...
[source,subs="attributes"]
----
$ docker run -e RUNTIME_TOOLS_TASK_CONSOLE_KOGITO_TASK_STATES_LIST=Started,Pending,Finished,Cancelled -e RUNTIME_TOOLS_TASK_CONSOLE_KOGITO_TASK_ACTIVE_STATES_LIST=Started,Pending -p 8280:8080 quay.io/bamoe/task-console:{IMAGE_VERSION_910}
----
...
$ docker run -e RUNTIME_TOOLS_TASK_CONSOLE_KOGITO_ENV_MODE=PROD
  ...
  -e KOGITO_CONSOLES_KEYCLOAK_REALM=kogito
  -e KOGITO_CONSOLES_KEYCLOAK_CLIENT_ID=kogito-console-react
  -p 8280:8080 quay.io/bamoe/task-console:{IMAGE_VERSION_910}
----