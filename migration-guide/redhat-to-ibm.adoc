...
Refer to the existing https://access.redhat.com/documentation/en-us/red_hat_process_automation_manager/7.0/html/migrating_from_red_hat_jboss_bpm_suite_6.4_to_red_hat_process_automation_manager_7.0/index[Red Hat Documentation] in order to facilitate migrating from {RH_BPMS} to {RH_PAM}/{RH_DM} v7.x.
...
[IMPORTANT]
====
Due to https://github.com/quarkusio/quarkus/issues/31011, It is recommend to use the Apache Maven version 3.8.6, or later.
====
...
_Now that you have the files, you can start to migrate our environment._
...
You can tailor your Maven environment to better suit their development needs by using these configurations.
