...
== DMNModel
To execute a DMN Decision you need to know the DMN model namespace and model name.
Both can be found in the properties panel of the DMN Editor.
In this example you can use namespace and model name from the <<_complete_example>>.
...
== DMNResult
In the example below you can execute the DMN model and consequently you can iterate its results.
You should be able to see results for all `Decision` nodes of the given DMN Model.
...
For executing <<_complete_example>> model, you must see output like below.
